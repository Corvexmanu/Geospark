       ...
       implements Serializable
{
   ...
   public static void main(String[] args)
   {
       ...
       try {
           ...
           //testSpatialJoinQuery();//Errors
           //testSpatialJoinQueryUsingIndex();//Errors
           ...
           throws Exception
   {
       ...
       System.out.println("The value for SpatialRangeQuery is " + resultSize);
   }
           ...
           throws Exception
   {
       ...
       System.out.println("The value for SpatialRangeQueryUsingIndex is " + resultSize);
   }
           ...
           throws Exception
   {
       ...
       System.out.println("The value for SpatialKnnQuery is " + result);
   }
           ...
           throws Exception
   {
       ...
       System.out.println("The value for DistanceJoinQuery is " + resultSize);
   }
           ...
           throws Exception
   {
       ...
       System.out.println("The value for DistanceJoinQueryUsingIndex is " + resultSize);
   }
           ...
           throws Exception
   {
       ...
       objectRDD.rawSpatialRDD.persist(StorageLevel.MEMORY_ONLY());
       long resultSize = RangeQuery.SpatialRangeQuery(objectRDD, rangeQueryWindow, false, false).count();
       System.out.println("The value for CRSTransformationSpatialRangeQuery is " + resultSize);
   }
           ...
           throws Exception
   {
       ...
       objectRDD.indexedRawRDD.persist(StorageLevel.MEMORY_ONLY());
       long resultSize = RangeQuery.SpatialRangeQuery(objectRDD, rangeQueryWindow, false, true).count();
       System.out.println("The value for CRSTransformationSpatialRangeQueryUsingIndex is " + resultSize);
   }
           ...
           throws Exception
   {
       ...
       try {
           long resultSize = RangeQuery.SpatialRangeQuery(spatialRDD, new Envelope(-180, 180, -90, 90), false, false).count();
           System.out.println("The value for LoadShapefileIntoPolygonRDD is " + resultSize);
       }
       catch (Exception e) {
